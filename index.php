...
<body>
    ...
    <header class="header">
        ...
        <ul id="main-menu">
                ...
                $menuList = layMenuChinh();
                foreach ($menuList as $menu): ?>
                    <li>
                        <a href="">
                            <?php echo $menu['tenMenu'] ?>
                        </a>
                        <!-- Kiểm tra xem menu chính có menu con hay không -->
                        <?php
                        $submenuList2 = hienMenuCon($menu['tenMenu']);
                        // Nếu list trống => đóng thẻ <li>
                        if (empty($submenuList2)) { ?>
                        </li>
                    <?php } else { ?>
                        <ul class="sub-menu">
                            <?php foreach ($submenuList2 as $menuCon2): ?>
                                <li>
                                    <a href="">
                                        <?php echo $menuCon2['tenMenu'] ?>
                                    </a>
                                    <?php
                                    // Kiểm tra xem menu cấp 2 có menu con không
                                    $submenuList3 = hienMenuCon($menuCon2['tenMenu']);
                                    if (empty($submenuList3)) {
                                        ?>
                                    </li>
                                <?php } else { ?>
                                    <ul class="sub-menu">
                                        <?php foreach ($submenuList3 as $menuCon3): ?>
                                            <li> <li> <a href="">
                                                    <?php echo $menuCon3['tenMenu'] ?>
                                                </a></li>  
                                        <?php endforeach ?> </li>
                                    </ul>
                                    </li>
